...
export default function Question1Screen() {
  ...
  const params = useLocalSearchParams() as Partial<{ words: string }>;
  ...
  useEffect(() => {
    try {
      ...
      Alert.alert("Error", "Failed to parse words.");
    } finally {
      setIsLoading(false);
    }
  }, [params.words]);
  ...
  const handleContinue = () => {
    ...
    if (remainingWords.length > 0) {
      // Navigate to Question2 with remaining words
      router.push({
        pathname: "/songs/question2",
        params: {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.contentContainer}>
        <Text style={styles.title}>Question Type 1</Text>
        ...
        <Text style={styles.description}>
          This is Question Type 1. You will answer a question about the word above.
        </Text>
      </View>
