...
categories = {
    ...
    "Emotions": [
        ...
        "doubt", "doubts", "doubtful", "downtrodden", "dreamy", "dubious", "eager", "ecstatic", "elated", "embarrassed", "emboldened", "emotional", 
        ...
        "guilt", "guilty", "happiness", "harassed", "hateful", "hated", "heartbroken", "helpless", 
        "hesitant", "hopeful", "hopefully", "exposed", "exuberant", "fascinated", 
        "hopeless", "horrified", "hostile", "humiliated", "humorous", "hungry", "hunger", 
        "hurt", "hurting", "hysterical", "hysteria", "impatient", "in_love", 
        ...
        "liberated", "lively", "loathing", "lonely", "loneliness", "longful", "lost", "loved", 
    ...
    "Body Parts": [
        ...
        "genital", "genitals", "groin", "gums", "hand", "hands", "hair", "head", "heel", "heels", 
    ...
    "Family": [
        ...
        "older_sister", "younger_brother", "baby_sister", "big_brother",
        ...
        "auntie", "nephew", "niece", "greatuncle", "greataunt", "cousin", "first_cousin", 
        "second_cousin", "third_cousin", "cousin-in-law", "husband", "wife", "spouse", "partner", 
        ...
        "stay-at-home_dad", "stay-at-home_mom", "breadwinner", "caregiver",
        ...
        "newborn", "baby", "childhood", "adulthood", "generation", "gen_Z", "millennial",
        "heir", "heiress", "successor", "progeny", "offspring", "family_bond", 
        "family_support", "discipline", "tradition", "roots", "homecoming",
        "mother_figure", "father_figure", "like_a_sister", "like_a_brother", "blood_relative",
...
multi_word_keywords = [
    ...
    "gen Z", "older sister", "younger brother", "baby sister", "big brother", 
    "first cousin", "second cousin", "third cousin", "cousin-in-law", 
    "stay-at-home dad", "stay-at-home mom", "blood relative", "biological parent", 
    ...
    "father figure", "like a sister", "like a brother", "life partner", "next of kin", 
    ...
    "family name", "maiden name", "surname", "last name", "first name", "given name", 
    ...
    # other categories
    "ice cream", "sweet potato", "whipped cream", "tank top", "tank tops", "in love", 
    "belly button", "vocal cords", "broken hearted", "broken heart", 
    "sea lion", "sea lions", "sea urchin", "sea urchins", "self conscious", 
